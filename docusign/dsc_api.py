...
from docusign.docusign.doctype.docusign_response_log.docusign_response_log import create_response_log
from docusign.docusign.doctype.docusign_request_log.docusign_request_log import create_request_log
...
def get_access_code(doctype, docname):
	...
	redirect_uri = get_request_site_address() +'/api/method/docusign.dsc_api.auth_login'
...
def get_signing_url(doctype,docname,token,code):
	try:
		...
		return_url = get_request_site_address() + "/api/method/docusign.dsc_api.get_signed_document?doctype=" + ds_doc.doctype+"&docname=" + ds_doc.name
